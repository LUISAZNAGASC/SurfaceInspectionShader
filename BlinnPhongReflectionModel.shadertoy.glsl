...
surface getSceneSurface(const in vec3 sampleTransformPosition)
{
    surface cubeGroup01Surface;
    {
        surface cube01Surface;
        {
            ...
            material cube01SurfaceMaterial = material(vec3(1.0f, 0.0f, 0.0f).rgb, 0.25f, vec3(1.0f, 0.0f, 0.0f).rgb, 0.75f, vec3(1.0f, 0.75f, 0.75f).rgb, 1.0f, 50.0f);
        ...
        surface cube02Surface;
        {
            ...
            material cube02SurfaceMaterial = material(vec3(0.0f, 1.0f, 0.0f).rgb, 0.25f, vec3(0.0f, 1.0f, 0.0f).rgb, 0.75f, vec3(0.75f, 1.0f, 0.75f).rgb, 1.0f, 50.0f);
        ...
        surface cube03Surface;
        {
            ...
            material cube03SurfaceMaterial = material(vec3(0.0f, 0.0f, 1.0f).rgb, 0.25f, vec3(0.0f, 0.0f, 1.0f).rgb, 0.75f, vec3(0.75f, 0.75f, 1.0f).rgb, 1.0f, 50.0f);
...
void setFragmentForegroundColor(inout vec3 fragmentOutputColor, const in vec3 cameraTransformPosition, const in vec3 cameraTransformDirection, const in surface raymarchSurface)
{
    ...
    pointlight pointlight01 = pointlight(vec3(-50.0f, 50.0f, -50.0f).xyz, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, 100.0f);
    ...
    pointlight pointlight02 = pointlight(vec3(50.0f, 50.0f, -50.0f).xyz, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, 100.0f);
    ...
    pointlight pointlight03 = pointlight(vec3(-50.0f, 50.0f, 50.0f).xyz, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, 100.0f);
    ...
    pointlight pointlight04 = pointlight(vec3(50.0f, 0.0f, 50.0f).xyz, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, vec3(1.0f, 1.0f, 1.0f).rgb, 1.0f, 100.0f);
